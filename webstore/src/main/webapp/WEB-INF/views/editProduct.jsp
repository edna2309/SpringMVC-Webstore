		...
		<form:form method="POST" modelAttribute="newProduct"
			...
			<fieldset>
				<legend  class="text-center">
					<strong style="font-size: 24px"><spring:message code="editProduct.izmjena" /></strong>
				</legend>
				...
				<div class="form-group">
					...
					<div class="col-lg-6">
						<form:input id="name" type="text" class="form:input-large"
							value="${newProduct.name}" path="name" />
				...
				<div class="form-group">
					...
					<div class="col-lg-6">
						<form:input id="unitPrice" type="text" class="form:input-large"
							value="${newProduct.unitPrice}" path="unitPrice" />
				...
				<div class="form-group">
					...
					<div class="col-lg-6">
						<form:input id="manufacturer" type="text" class="form:input-large"
							value="${newProduct.manufacturer}" path="manufacturer" />
				...
				<div class="form-group">
					...
					<div class="col-lg-6">
						<form:input id="category" type="text" class="form:input-large"
							value="${newProduct.category}" path="category" />
				...
				<div class="form-group">
					...
					<div class="col-lg-6">
						<form:input id="unitsInStock" value="${newProduct.unitsInStock}"
							path="unitsInStock" type="text" class="form:input-large" />
				...
				<div class="form-group">
					<div class="col-lg-offset-3 col-lg-6 text-center">
						<input type="submit" id="btnEdit" class="btn Edit btn-primary" style="width: 50%"
							value="EDIT" />
					</div>
				</div>
